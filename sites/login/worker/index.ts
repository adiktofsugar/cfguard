...
async function getOrCreateKeyPair(env: Env): Promise<{ privateKey: CryptoKey; publicJwk: JsonWebKey }> {
  ...
  await env.AUTH_STORAGE.put('signing-key.json', JSON.stringify({
    privateJwk,
    publicJwk
  }));
